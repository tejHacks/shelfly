...
//               className="w-120 h-90 rounded-2xl mb-3"
//             />
//           ) : (
//             <View className="w-80 h-48 rounded-2xl bg-gray-100 mb-3 items-center justify-center">
//               <Text className="text-gray-400">No image selected</Text>
//             </View>
//           )}

//           <View className="flex-row space-x-10 gap-6 my-5">
//             <TouchableOpacity
//               onPress={handleTakePhoto}
//               className="bg-green-700 px-8 py-3 rounded-xl"
//             >
